...
export type AppState = DeepImmutable<{
  ...
  // Local ultraplan mode: prompt to be processed after plan mode is activated.
  // Set by handleLocalUltraplan; cleared by REPL after processing.
  ultraplanLocalPrompt?: string
